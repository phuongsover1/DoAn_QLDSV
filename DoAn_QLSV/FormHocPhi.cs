...
namespace DoAn_QLSV
{
    public partial class FormHocPhi : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            this.sp_ds_ct_hoc_phiTableAdapter.Connection.ConnectionString = Program.connstr;
            //DataRowView drv;
        ...
        {
            this.sp_ds_hoc_phiTableAdapter.Connection.ConnectionString = Program.connstr;
