namespace DoAn_QLSV
{
	partial class FormQuanLyLopTinChi
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormQuanLyLopTinChi));
			...
			this.btnChonGiangVien = new DevExpress.XtraEditors.SimpleButton();
			this.txtGiangVien = new DevExpress.XtraEditors.TextEdit();
			this.labelControl8 = new DevExpress.XtraEditors.LabelControl();
			this.btnChonMonHoc = new DevExpress.XtraEditors.SimpleButton();
			...
			this.groupControl1.Size = new System.Drawing.Size(956, 111);
			...
			this.cmbKhoa.Size = new System.Drawing.Size(227, 21);
			this.cmbKhoa.TabIndex = 8;
			this.cmbKhoa.SelectedIndexChanged += new System.EventHandler(this.cmbKhoa_SelectedIndexChanged);
			// 
			// labelControl9
			// 
			this.labelControl9.Location = new System.Drawing.Point(12, 79);
			...
			this.gridLTC.Location = new System.Drawing.Point(0, 111);
			this.gridLTC.MainView = this.gridView1;
			this.gridLTC.Name = "gridLTC";
			this.gridLTC.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.btnDelete});
			this.gridLTC.Size = new System.Drawing.Size(956, 358);
			this.gridLTC.TabIndex = 7;
			...
			// 
			this.groupControlThongTinMonHoc.Controls.Add(this.btnChonGiangVien);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtGiangVien);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl8);
			this.groupControlThongTinMonHoc.Controls.Add(this.btnChonMonHoc);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtMaMH);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl7);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtMaKhoa);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl6);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtHocKy);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl1);
			this.groupControlThongTinMonHoc.Controls.Add(this.btnHuy);
			this.groupControlThongTinMonHoc.Controls.Add(this.btnLuu);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtSoSVToiThieu);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl5);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtNhom);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl4);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtNienKhoa);
			this.groupControlThongTinMonHoc.Controls.Add(this.labelControl3);
			this.groupControlThongTinMonHoc.Controls.Add(this.txtLTC);
			...
			this.groupControlThongTinMonHoc.Location = new System.Drawing.Point(0, 272);
			this.groupControlThongTinMonHoc.Name = "groupControlThongTinMonHoc";
			this.groupControlThongTinMonHoc.Size = new System.Drawing.Size(956, 197);
			this.groupControlThongTinMonHoc.TabIndex = 8;
			this.groupControlThongTinMonHoc.Text = "Thông Tin Của Lớp";
			this.groupControlThongTinMonHoc.Visible = false;
			// 
			// btnChonGiangVien
			// 
			this.btnChonGiangVien.Location = new System.Drawing.Point(859, 77);
			this.btnChonGiangVien.Name = "btnChonGiangVien";
			this.btnChonGiangVien.Size = new System.Drawing.Size(85, 23);
			this.btnChonGiangVien.TabIndex = 16;
			...
			this.txtGiangVien.Location = new System.Drawing.Point(744, 79);
			this.txtGiangVien.Name = "txtGiangVien";
			this.txtGiangVien.Size = new System.Drawing.Size(100, 20);
			this.txtGiangVien.TabIndex = 15;
			// 
			// labelControl8
			// 
			this.labelControl8.Location = new System.Drawing.Point(667, 82);
			this.labelControl8.Name = "labelControl8";
			this.labelControl8.Size = new System.Drawing.Size(71, 13);
			this.labelControl8.TabIndex = 14;
			this.labelControl8.Text = "Mã Giảng Viên:";
			// 
			// btnChonMonHoc
			// 
			this.btnChonMonHoc.Location = new System.Drawing.Point(859, 33);
			this.btnChonMonHoc.Name = "btnChonMonHoc";
			this.btnChonMonHoc.Size = new System.Drawing.Size(85, 23);
			this.btnChonMonHoc.TabIndex = 13;
			this.btnChonMonHoc.Text = "Chọn Môn Học";
			this.btnChonMonHoc.Click += new System.EventHandler(this.btnChonMonHoc_Click);
			// 
			// txtMaMH
			// 
			this.txtMaMH.Enabled = false;
			this.txtMaMH.Location = new System.Drawing.Point(744, 35);
			...
			// labelControl7
			// 
			this.labelControl7.Location = new System.Drawing.Point(667, 38);
			this.labelControl7.Name = "labelControl7";
			this.labelControl7.Size = new System.Drawing.Size(62, 13);
			this.labelControl7.TabIndex = 11;
			this.labelControl7.Text = "Mã Môn Học:";
			// 
			// txtMaKhoa
			// 
			this.txtMaKhoa.Enabled = false;
			this.txtMaKhoa.Location = new System.Drawing.Point(445, 124);
			...
			// labelControl6
			// 
			this.labelControl6.Location = new System.Drawing.Point(331, 127);
			this.labelControl6.Name = "labelControl6";
			this.labelControl6.Size = new System.Drawing.Size(45, 13);
			this.labelControl6.TabIndex = 10;
			this.labelControl6.Text = "Mã Khoa:";
			// 
			// txtHocKy
			// 
			this.txtHocKy.Location = new System.Drawing.Point(117, 124);
			this.txtHocKy.Name = "txtHocKy";
			this.txtHocKy.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.txtHocKy.Size = new System.Drawing.Size(179, 20);
			this.txtHocKy.TabIndex = 7;
			// 
			// labelControl1
			// 
			this.labelControl1.Location = new System.Drawing.Point(40, 127);
			...
			// btnHuy
			// 
			this.btnHuy.Location = new System.Drawing.Point(869, 121);
			...
			// btnLuu
			// 
			this.btnLuu.Location = new System.Drawing.Point(769, 121);
			...
			// txtSoSVToiThieu
			// 
			this.txtSoSVToiThieu.Location = new System.Drawing.Point(445, 79);
			this.txtSoSVToiThieu.Name = "txtSoSVToiThieu";
			this.txtSoSVToiThieu.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.txtSoSVToiThieu.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.txtSoSVToiThieu.Size = new System.Drawing.Size(179, 20);
			this.txtSoSVToiThieu.TabIndex = 4;
			// 
			// labelControl5
			// 
			this.labelControl5.Location = new System.Drawing.Point(331, 82);
			this.labelControl5.Name = "labelControl5";
			this.labelControl5.Size = new System.Drawing.Size(108, 13);
			this.labelControl5.TabIndex = 6;
			this.labelControl5.Text = "Số Sinh Viên Tối Thiểu:";
			// 
			// txtNhom
			// 
			this.txtNhom.Location = new System.Drawing.Point(445, 35);
			this.txtNhom.Name = "txtNhom";
			this.txtNhom.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.txtNhom.Size = new System.Drawing.Size(179, 20);
			this.txtNhom.TabIndex = 3;
			// 
			// labelControl4
			// 
			this.labelControl4.Location = new System.Drawing.Point(331, 38);
			...
			// txtNienKhoa
			// 
			this.txtNienKhoa.Location = new System.Drawing.Point(117, 79);
			this.txtNienKhoa.Name = "txtNienKhoa";
			this.txtNienKhoa.Size = new System.Drawing.Size(179, 20);
			this.txtNienKhoa.TabIndex = 2;
			// 
			// labelControl3
			// 
			this.labelControl3.Location = new System.Drawing.Point(37, 82);
			...
			// txtLTC
			// 
			this.txtLTC.Enabled = false;
			this.txtLTC.Location = new System.Drawing.Point(117, 35);
			this.txtLTC.Name = "txtLTC";
			this.txtLTC.Size = new System.Drawing.Size(179, 20);
			this.txtLTC.TabIndex = 1;
			// 
			// labelControl2
			// 
			...
			this.labelControl2.Text = "Mã Lớp Tín Chỉ:";
			// 
			// FormQuanLyLopTinChi
			// 
			...
			this.Controls.Add(this.gridLTC);
			this.Controls.Add(this.groupControl1);
			this.Name = "FormQuanLyLopTinChi";
			this.Text = "Quản Lý Lớp Tín Chỉ";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.FormQuanLyLopTinChi_Load);
		...
		private DevExpress.XtraEditors.SimpleButton btnChonMonHoc;
		private DevExpress.XtraEditors.SimpleButton btnChonGiangVien;
