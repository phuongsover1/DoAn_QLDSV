...
namespace DoAn_QLSV
{
	partial class FormHocPhi
	{
		...
		private void InitializeComponent()
		{
			...
			this.sp_ds_hoc_phiBindingNavigatorSaveItem = new System.Windows.Forms.ToolStripButton();
			...
			this.sp_ds_hoc_phiGridControl = new DevExpress.XtraGrid.GridControl();
			this.gridView1 = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.sp_ds_ct_hoc_phiBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.sp_ds_ct_hoc_phiTableAdapter = new DoAn_QLSV.QLDSV_TCDataSetTableAdapters.sp_ds_ct_hoc_phiTableAdapter();
			this.sp_ds_ct_hoc_phiGridControl = new DevExpress.XtraGrid.GridControl();
			this.gridView2 = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.Hoc = new System.Windows.Forms.GroupBox();
			this.btnThem = new System.Windows.Forms.Button();
			this.txtHocKy1 = new DevExpress.XtraEditors.TextEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiBindingNavigator)).BeginInit();
			this.sp_ds_hoc_phiBindingNavigator.SuspendLayout();
			this.fillToolStrip.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiGridControl)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_ct_hoc_phiBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_ct_hoc_phiGridControl)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView2)).BeginInit();
			this.Hoc.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.txtHocKy1.Properties)).BeginInit();
			...
			// 
			// sp_ds_hoc_phiBindingSource
			// 
			this.sp_ds_hoc_phiBindingSource.DataMember = "sp_ds_hoc_phi";
			this.sp_ds_hoc_phiBindingSource.DataSource = this.qLDSV_TCDataSet;
			// 
			// sp_ds_hoc_phiTableAdapter
			// 
			this.sp_ds_hoc_phiTableAdapter.ClearBeforeFill = true;
			// 
			// tableAdapterManager
			// 
			...
			// 
			this.sp_ds_hoc_phiBindingNavigator.AddNewItem = this.bindingNavigatorAddNewItem;
			this.sp_ds_hoc_phiBindingNavigator.BindingSource = this.sp_ds_hoc_phiBindingSource;
			this.sp_ds_hoc_phiBindingNavigator.CountItem = this.bindingNavigatorCountItem;
			...
			this.sp_ds_hoc_phiBindingNavigator.MoveNextItem = this.bindingNavigatorMoveNextItem;
			...
			// 
			// sp_ds_hoc_phiBindingNavigatorSaveItem
			// 
			this.sp_ds_hoc_phiBindingNavigatorSaveItem.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			...
			// 
			// sp_ds_ct_hoc_phiBindingSource
			// 
			this.sp_ds_ct_hoc_phiBindingSource.DataMember = "sp_ds_ct_hoc_phi";
			this.sp_ds_ct_hoc_phiBindingSource.DataSource = this.qLDSV_TCDataSet;
			// 
			// sp_ds_ct_hoc_phiTableAdapter
			// 
			this.sp_ds_ct_hoc_phiTableAdapter.ClearBeforeFill = true;
			// 
			...
			// Hoc
			// 
			this.Hoc.Controls.Add(this.btnThem);
			this.Hoc.Controls.Add(this.txtHocKy1);
			this.Hoc.Controls.Add(this.txtNienKhoa1);
			this.Hoc.Controls.Add(this.txtHocPhi);
			...
			this.groupBox1.Controls.Add(this.dteNgay);
			...
			this.Controls.Add(this.sp_ds_ct_hoc_phiGridControl);
			...
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiBindingNavigator)).EndInit();
			this.sp_ds_hoc_phiBindingNavigator.ResumeLayout(false);
			this.sp_ds_hoc_phiBindingNavigator.PerformLayout();
			this.fillToolStrip.ResumeLayout(false);
			this.fillToolStrip.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_hoc_phiGridControl)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_ct_hoc_phiBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.sp_ds_ct_hoc_phiGridControl)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView2)).EndInit();
			this.Hoc.ResumeLayout(false);
			this.Hoc.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.txtHocKy1.Properties)).EndInit();
		...
		private System.Windows.Forms.BindingSource sp_ds_hoc_phiBindingSource;
		private QLDSV_TCDataSetTableAdapters.sp_ds_hoc_phiTableAdapter sp_ds_hoc_phiTableAdapter;
		private QLDSV_TCDataSetTableAdapters.TableAdapterManager tableAdapterManager;
		private System.Windows.Forms.BindingNavigator sp_ds_hoc_phiBindingNavigator;
		...
		private System.Windows.Forms.ToolStripButton sp_ds_hoc_phiBindingNavigatorSaveItem;
		...
		private DevExpress.XtraGrid.GridControl sp_ds_hoc_phiGridControl;
		private DevExpress.XtraGrid.Views.Grid.GridView gridView1;
		private System.Windows.Forms.BindingSource sp_ds_ct_hoc_phiBindingSource;
		private QLDSV_TCDataSetTableAdapters.sp_ds_ct_hoc_phiTableAdapter sp_ds_ct_hoc_phiTableAdapter;
		private DevExpress.XtraGrid.GridControl sp_ds_ct_hoc_phiGridControl;
		private DevExpress.XtraGrid.Views.Grid.GridView gridView2;
		private System.Windows.Forms.GroupBox Hoc;
		private System.Windows.Forms.Button btnThem;
		private DevExpress.XtraEditors.TextEdit txtHocKy1;
